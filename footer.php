 <footer class="footer">
      <div class="container">
        ...
        <div class="footer__social-network">
          ...
          <div class="footer__social-links">
            <a href="#" class="footer__link">
              <img src="/img/fb.svg" alt="" class="">
            </a>
            <a href="#" class="footer__link">
              <img src="/img/yt.svg" alt="" class="">
            </a>
            <a href="#" class="footer__link">
              <img src="/img/inst.svg" alt="" class="">
            </a>
          </div>
        ...
        <div class="footer__contact-details">
          ...
          <ul class="footer__ul">
            <li class="footer__item">
              <img class="footer__icon" src="/img/loc.svg" alt="">
              9748 Blossom Hill Rd undefined Lansing, Idaho 68545 United States
            </li>
            <li class="footer__item">
              <img class="footer__icon" src="/img/call2.svg" alt="">
            ...
            <li class="footer__item">
              ...
              mailto:cherly.lawson@example.com
            </li>
          </ul>
        </div>
        <div class="footer__contact-form">
          ...
          <form action="#" class="footer__form">
            <input type="text" class="input__footer-input" placeholder="Your Full Name*">
            <input type="text" class="input__footer-input" placeholder="Phone Number*">
